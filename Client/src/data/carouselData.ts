// Carousel slide data for the homepage
export const homeCarouselSlides = [
  ...
  },
  {
    ...
    subtitle: "Supporting Critical Sectors",
    description: "Trusted partner for Oil & Gas, Power Plants, Petrochemicals, Iron & Steel, Heavy Equipment, and more industries worldwide.",
    image: '/Carousel.png'
  },
  {
